...
namespace DAL
{
    public class UserGroupDAL
    {
        ...
        public DataTable Read()
        {
            ...
            string cmd = "SELECT dbo.UserAccessRoles.id, dbo.UserGroups.Title AS [گروه کاربری], dbo.UserAccessRoles.Section AS [بخش مربوط], dbo.UserAccessRoles.CanEnter AS [دسترسی ورود], dbo.UserAccessRoles.CanCreate AS [دسترسی افزودن], dbo.UserAccessRoles.CanUpdate AS [دسترسی ویرایش], dbo.UserAccessRoles.CanDelete AS [دسترسی حذف] FROM dbo.UserAccessRoles INNER JOIN dbo.UserGroups ON dbo.UserAccessRoles.UserGroup_id = dbo.UserGroups.id";
